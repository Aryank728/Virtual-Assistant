...
def sendmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('kumararyan1929@gmail.com', 'Aryan@2021')
    server.sendmail('kumararyan1929@gmail.com', to, content)
    server.close()
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            codepath = "C:\\Users\\Aryan\\Documents"
            os.startfile(codepath)
